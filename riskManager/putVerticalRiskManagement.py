...
class PutVerticalRiskManagement(riskManagement.RiskManagement):
  ...
  def __init__(self, managementType: PutVerticalManagementStrategyTypes, closeDuration: int) -> None:
  ...
  def managePosition(self, currentPosition:optionPrimitive) -> bool:
    ...
    if self.__closeDuration is not None:
      ...
      if currentPosition.calcProfitLossPercentage() >= 50 or currentPosition.getNumberOfDaysLeft() == self.__closeDuration:
        return True
