...
class Portfolio(object):
    ...
    def onSignal(self, event):
        ...
        # TODO: need a better way to decide if we allow multiple underlyings; perhaps using enable / disable from
    ...
    def __calcPortfolioValues(self, curPosition):
        ...
        # TODO: Add PLopen, PLday, PLopenPercent PLdayPercent calculations
